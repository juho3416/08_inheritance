...
public class InheritanceService {
	...
	public void ex1() {
		...
		emp.breath();	
		// 상속의 특징 : 코드 추가 및 
		// 				수정에 용이함. (한번만 수정하면 되므로)
		// -> 부모에게 정의하면 상속받은 자식들은 모두 부모의 것을
		// 그대로 받아서 쓸 수 있음!
	...
	public void ex2() {
		...
		Student std = new Student("김철수", 171, "한국", 1, 3); 
		// getter/setter 아니고 매개변수생성자 쪽으로 값이 감.
		// getter/setter는 getter/setter를 사용했을때만 값이 감.
	...
	public void ex4() {
		...
		Person p = new Person();
		// Object를 상속 받은 Person객체 생성
		
		Student std = new Student();
		//Person을 상속받은 Student객체 생성
		
		// Object - Person - Student (상속)
		
		
		System.out.println(p.hashCode());
		System.out.println(std.hashCode());
		// Person이 Object에서 물려받은 hasCode()를
		// Student가 또 물려받아 사용
		...
		// String이 Object 상속 받은 것. String - Object
		System.out.println(sc.hashCode());
		// Scanner가 Object 상속 받은 것. Scanner - Object
